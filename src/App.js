    ...
    <div className="wrapper">
      ...
      <header className="header">
         <div className='header__inner'>
            <h2>My shop</h2>
            <div className="panel">
            <svg className='cart' width={20} height={20} xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 20 20"  >
            ...
            <p>5000</p>
            <svg  className='favorite' width={20} height={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 19" >
